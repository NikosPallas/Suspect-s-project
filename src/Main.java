...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*for(int i = 0;i<Registry.getListOfSuspects().size();i++) {
			for(int j=0;j<Registry.getListOfSuspects().get(i).getListOfPartners().size();j++) {
			System.out.println(Registry.getListOfSuspects().get(i).getListOfPartners().get(j).getName());
